...
\* **Better Auth** : Fine-tuned, vendor-agnostic authentication
 ...
 _Full_ \*TypeScript\*\* support

 _Production-ready patterns for_ \*authentication\*\* and **authorization**.
...
More detailed reasoning can be found in [DECISIONS.md](http://DECISIONS.md).

#### Batteries Included (for a Fine User Experience)

1. Magic links and email provider 
